  ...
  const blogPosts = [
    {
      ...
      date: "March 15, 2024",
      excerpt:
        "A comprehensive guide to implementing Redux for complex state management in modern React applications.",
      readTime: "8 min read",
    },
    {
      ...
      date: "March 10, 2024",
      excerpt:
        "Learn how to create robust and scalable APIs using Node.js, Express.js, and best practices for backend development.",
    ...
    },
    {
      ...
      date: "March 5, 2024",
      excerpt:
        "Essential strategies and techniques to optimize MongoDB queries and improve database performance.",
      readTime: "7 min read",
    },
  ];

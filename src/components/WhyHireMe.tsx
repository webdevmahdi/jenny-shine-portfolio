          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
                Why You <span className="text-orange">Hire Me</span> for Your
                Next Projects?
              </h2>

              <p className="text-lg text-muted-foreground leading-relaxed">
                With over 7 years of experience specializing in the MERN stack,
                I've honed my skills in React.js, Node.js, Express.js, Redux,
                MongoDB, TypeScript, C++, and more to perfection. Throughout my
                career, I've consistently demonstrated the ability to create
                dynamic and user-friendly web applications that drive business
                growth. What sets me apart is not just my technical proficiency
                but also my commitment to understanding each project's unique
                needs and delivering tailored solutions that make a tangible
                difference.
              </p>
            </div>

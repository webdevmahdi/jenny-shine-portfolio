        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Profile Image */}
              <div className="w-80 h-80 rounded-full bg-gradient-to-br from-orange/20 to-orange/40 flex items-center justify-center border-4 animate-up-and-down border-background overflow-hidden">
                <img
